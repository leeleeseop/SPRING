 ...
 */
 ...
 function toTime(timeStemp){
 	...
 	// console.log("dateTime.js - hh : " + hh + ", mi : " + mi + ", ss : " + ss);
 	// console.log("dateTime.js - " + ((hh > 9 ? "" : "0") + hh) + ":"
 	// 	+ ((mi > 9 ? "" : "0") + mi) + ":"
 	// 	+ ((ss > 9 ? "" : "0") + ss));
 ...
 function toDateTime(timeStemp){
 	...
 	if(gap < (1000 * 60 * 60 * 24)){
 		...
 		// console.log("dateTime.js time str : " + str);
 		// console.log("dateTime.js time str : " + toTime(timeStemp));
 	 	return str;
 	}
 	// 24시간이 지난 경우는 날짜 표시
